...
module.exports = {
    ...
    async execute(interaction){
        ...
        if(!voiceChannel){
            let snark = ['You must be in a voice channel to skip forward, you silly little troll, you.',
                        'Hey bud. Join a voice channel first, mkay?',
                        'Thats a good one. Too bad I\'m not gonna skip forward unless you first join a voice channel.',
